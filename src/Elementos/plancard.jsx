...
const CheckIcon = ({ disabled }) => {
  const colorClass = disabled ? 'text-gray-400 dark:text-gray-500' : 'text-blue-700 dark:text-blue-500';
  return (
    <svg className={`shrink-0 w-4 h-4 ${colorClass}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
